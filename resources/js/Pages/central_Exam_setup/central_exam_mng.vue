            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                <table class="w-full table-auto text-xl">
                    <thead>
                        <tr class="bg-emerald-50 text-emerald-800">
                            ...
                            <th class="px-6 py-3 text-left font-semibold">নিবন্ধন সেটাপ</th>
                            <th class="px-6 py-3 text-left font-semibold">অন্তর্ভুক্তি সেটাপ</th>
                            <th class="px-6 py-3 text-left font-semibold">অন্যান্য সেটাপ</th>
                        </tr>
                    </thead>
                ...
                <div class="flex justify-between items-center px-6 py-4 bg-gray-50 border-t border-gray-100">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="px-4 py-2 border border-gray-300 rounded-sm bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200">←
                            পূর্ববর্তী</button>
                        <button
                            class="px-4 py-2 border border-emerald-500 rounded-sm bg-emerald-500 text-white hover:bg-emerald-600 transition-colors duration-200">১</button>
                        <button
                            class="px-4 py-2 border border-gray-300 rounded-sm bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200">পরবর্তী
                            →</button>
                    </div>
                </div>
            </div>
