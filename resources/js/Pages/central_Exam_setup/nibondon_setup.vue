      ...
      <div class="bg-white rounded-sm shadow-md border border-emerald-100">
        ...
        <div class="bg-emerald-50 p-6 rounded-t-sm border-b border-emerald-100">
          <div class="flex items-center justify-center gap-3">
            ...
            <h2 class="text-2xl font-bold text-emerald-800">৪৮তম কেন্দ্রীয় পরীক্ষা নিবন্ধন সেটআপ</h2>
          </div>
        </div>
...
import { ref } from 'vue'
  ...
  const rows = ref([
    {
      examName: 'ফযিলত',
      dateFrom1: '2024-07-10',
      dateTo1: '2024-08-25',
      fee1: 200,
      invest1Men: 300,
      invest1Madan: 300,
      invest1Others: 300,
      dateFrom2: '2024-07-25',
      dateTo2: '2024-07-25',
      fee2: 300,
      invest2Men: 400,
      invest2Madan: 400,
  ...
  const submit = () => {
    console.log('Submitted Data:', rows.value)
  }
